...
1. Add a reference to the NuGet package package `HotChocolate.AspNetCore` version `10.5.2`.
   1. `dotnet add GraphQL package HotChocolate.AspNetCore --version 10.5.2`
