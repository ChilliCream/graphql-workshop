...
1. Add a reference to the NuGet package package `HotChocolate.AspNetCore` version `11.0.0-rc.2`.
   1. `dotnet add GraphQL package HotChocolate.AspNetCore --version 11.0.0-rc.2`
