...
1. Add a reference to the NuGet package `HotChocolate.Subscriptions.Redis` version `14.0.0-p.139`:
    - `dotnet add GraphQL package HotChocolate.Subscriptions.Redis --version 14.0.0-p.139`
