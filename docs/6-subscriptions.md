...
1. Add a reference to the NuGet package `HotChocolate.Subscriptions.Redis` version `14.0.0-rc.1`:
    - `dotnet add GraphQL package HotChocolate.Subscriptions.Redis --version 14.0.0-rc.1`
