...
1. Add a reference to the NuGet package `HotChocolate.Data.EntityFramework` version `15.1.14`:
    - `dotnet add GraphQL package HotChocolate.Data.EntityFramework --version 15.1.14`
...
1. Add a reference to the NuGet package `HotChocolate.Data` version `15.1.14`:
    - `dotnet add GraphQL package HotChocolate.Data --version 15.1.14`
