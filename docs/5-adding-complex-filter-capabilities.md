...
1. Add a reference to the NuGet package `HotChocolate.Data.EntityFramework` version `14.0.0-p.187`:
    - `dotnet add GraphQL package HotChocolate.Data.EntityFramework --version 14.0.0-p.187`
...
1. Add a reference to the NuGet package `HotChocolate.Pagination.EntityFramework` version `14.0.0-p.187`:
    - `dotnet add GraphQL package HotChocolate.Pagination.EntityFramework --version 14.0.0-p.187`
...
1. Add a reference to the NuGet package `HotChocolate.Data` version `14.0.0-p.187`:
    - `dotnet add GraphQL package HotChocolate.Data --version 14.0.0-p.187`
