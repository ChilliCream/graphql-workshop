...
1. Add a reference to the NuGet package `HotChocolate.Data.EntityFramework` version `15.0.3`:
    - `dotnet add GraphQL package HotChocolate.Data.EntityFramework --version 15.0.3`
...
1. Add a reference to the NuGet package `HotChocolate.Data` version `15.0.3`:
    - `dotnet add GraphQL package HotChocolate.Data --version 15.0.3`
