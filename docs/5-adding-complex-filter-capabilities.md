...
1. Add a reference to the NuGet package package `HotChocolate.Data` version `14.0.0-p.144`:
    - `dotnet add GraphQL package HotChocolate.Data --version 14.0.0-p.144`
