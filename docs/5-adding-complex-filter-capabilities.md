...
1. Add a reference to the NuGet package `HotChocolate.Data.EntityFramework` version `16.6.7`:
    - `dotnet add GraphQL package HotChocolate.Data.EntityFramework --version 16.6.7`
...
1. Add a reference to the NuGet package `HotChocolate.Data` version `16.6.7`:
    - `dotnet add GraphQL package HotChocolate.Data --version 16.6.7`
