...
1. Add a reference to the NuGet package `HotChocolate.Data.EntityFramework` version `14.2.0`:
    - `dotnet add GraphQL package HotChocolate.Data.EntityFramework --version 14.2.0`
...
1. Add a reference to the NuGet package `HotChocolate.Pagination.EntityFramework` version `14.2.0`:
    - `dotnet add GraphQL package HotChocolate.Pagination.EntityFramework --version 14.2.0`
...
1. Add a reference to the NuGet package `HotChocolate.Data` version `14.2.0`:
    - `dotnet add GraphQL package HotChocolate.Data --version 14.2.0`
